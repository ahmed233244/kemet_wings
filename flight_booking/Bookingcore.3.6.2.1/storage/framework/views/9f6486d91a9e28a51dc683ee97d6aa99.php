...
<div class="col-md-12">
    <div class="form-group">
        <label><?php echo e(__("Adult Price")); ?> <span class="text-danger">*</span></label>
        <input type="number" required value="<?php echo e($row->price); ?>" min="1" placeholder="<?php echo e(__("Adult Price")); ?>" name="price" class="form-control">
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label><?php echo e(__("Infant Price")); ?> <span class="text-danger">*</span></label>
        <input type="number" required value="<?php echo e($row->infant_price); ?>" min="1" placeholder="<?php echo e(__("Infant Price")); ?>" name="infant_price" class="form-control">
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
        <label><?php echo e(__("Child Price")); ?> <span class="text-danger">*</span></label>
        <input type="number" required value="<?php echo e($row->child_price); ?>" min="1" placeholder="<?php echo e(__("Child Price")); ?>" name="child_price" class="form-control">
    </div>
</div>
<div class="col-md-12">
    <div class="form-group">
...
</div><?php /**PATH C:\Users\PC\Documents\flight_booking\Bookingcore.3.6.2\modules/Flight/Views/admin/flight/seat/form.blade.php ENDPATH**/ ?>