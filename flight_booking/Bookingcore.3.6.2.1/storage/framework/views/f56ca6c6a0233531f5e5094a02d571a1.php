...
<script>
  ...
  const ticket = {
    ...
    ticketid:"<?php echo e($booking->code); ?>",
    segments: <?php 
    ...
    <div class="ticket-container" id="ticket${idx}">
      ...
      <div class="ticket-header">
                    ...
                    <?php if($logo_id): ?>
                        ...
                        <img height='40px' src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
                    <?php endif; ?>
                </a>
        <div>
...
<?php /**PATH C:\Users\PC\Documents\flight_booking\Bookingcore.3.6.2.1\themes/Base/Booking/Views/frontend/detail/ticket.blade.php ENDPATH**/ ?>