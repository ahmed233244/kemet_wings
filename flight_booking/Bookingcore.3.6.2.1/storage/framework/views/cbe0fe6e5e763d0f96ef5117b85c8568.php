...
<head>
    ...
    <title>AirConnect Flight Booking</title>
            ...
            <div class="header-content">
                <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo">
                    ...
                    <?php if($logo_id): ?>
                        ...
                        <img height='70px' src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
                    <?php endif; ?>
                </a>
...
<script>
const tripData = {
  trip_type: "<?php echo e($_REQUEST['trip_type']); ?>",
  from_where: <?php echo json_encode($_REQUEST['from_where']); ?>,
  to_where: <?php echo json_encode($_REQUEST['to_where']); ?>,
  start: <?php echo json_encode($_REQUEST['start']); ?>,
  adults: "<?php echo e($_REQUEST['adults']); ?>",
  children: "<?php echo e($_REQUEST['children']); ?>",
  infants: "<?php echo e($_REQUEST['infants']); ?>",
};
const flights_by_segment = <?php echo json_encode($rows); ?>;
...
</html><?php /**PATH C:\Users\PC\Documents\flight_booking\Bookingcore.3.6.2.1\themes/BC/Flight/Views/frontend/search.blade.php ENDPATH**/ ?>