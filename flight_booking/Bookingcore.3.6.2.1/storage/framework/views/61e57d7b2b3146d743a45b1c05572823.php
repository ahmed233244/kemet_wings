...
<body>
                                        ...
                                        <div class="form-content">
                                            ...
                                            <select required class="form-select select2-location from-where-select" name="from_where[]" data-placeholder="Select location">
                                                ...
                                                <?php $__currentLoopData = $locationOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($option['id']); ?>"><?php echo e($option['text']); ?></option>
    ...
    <script>
        ...
        window.locationOptions = <?php echo json_encode($locationOptions, 15, 512) ?>;
...
</html><?php /**PATH C:\Users\PC\Documents\flight_booking\Bookingcore.3.6.2.1\themes/BC/Flight/Views/frontend/layouts/search/form-search.blade.php ENDPATH**/ ?>