            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="add_bulk" class="form-control" value="" placeholder="<?php echo e(__("Add Bulk")); ?>">
                    </div>
                </div>
                                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">Starts At</label>
                        <input type="date" name="starts_at" class="form-control" value="" placeholder="<?php echo e(__("Starts At")); ?>">
                    </div>
                </div>
                                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">Ends at</label>
                        <input type="date" name="ends_at" class="form-control" value="" placeholder="<?php echo e(__("Ends At")); ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">Recurring Day</label>
                        <select  name="recurring_day[]" class="form-control" value="" placeholder="<?php echo e(__("Recurring Day")); ?>" multiple>
...
<?php /**PATH C:\Users\PC\Documents\flight_booking\Bookingcore.3.6.2.1\modules/Flight/Views/admin/flight/form.blade.php ENDPATH**/ ?>