                ...
                @foreach($review_list as $item)
                    ...
                    <div class="review-item">
                        ...
                        <div class="review-item-body">
                            ...
                            @if($item->author_id == Auth::id() and setting_item("enable_edit_review",false))
                                <div class="d-flex justify-content-end">
                                    <button class="btn btn-sm btn-light review_edit" data-id="{{ $item->id }}" data-title="{{$item->title}}" data-content="{{$item->content}}">
                                        {{ __("Edit") }}
                                    </button>
                                </div>
                            @endif
            ...
            <div class="review-form" id="form-reviews">
                ...
                <div class="form-wrapper">
                    ...
                    <form action="{{ route('review.store')}}" class="needs-validation" novalidate method="post">
                        ...
                        @endif
                        @if(setting_item("review_enable_recaptcha"))
                            <div class="form-group">
                                {{ recaptcha_field('review') }}
                            </div>
                        @endif
                        <div class="text-center">
                            ...
                            <input id="submit" type="submit" name="submit" class="btn" data-text-update="{{__("Update Review")}}" data-text-value="{{__("Leave a Review")}}" value="{{__("Leave a Review")}}">
                        </div>
                    </form>
                </div>
            </div>
